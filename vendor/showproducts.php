<div class="flex-w flex-sb-m p-b-52">
			...
			<div class="row isotope-grid">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item <?php echo $row['cate'] ?>">
					<!-- Block2 -->
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							...
							<div class="block2-txt-child2 flex-r p-t-3">
								<button name="button" id="<?php echo $row['id']?>" onclick="addWish(<?php echo $row['id']?>,'<?php echo $row['name']?>')" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2">
...
<script type="text/javascript">
	function addWish(id, s){
		...
		xmlhttp.open("GET", "wishlist.php?q=" + id, true);
	    xmlhttp.send();
	}
	}
	var arr = addWish();
	for (var i = 0; i < arr.length; i++) {
		for (var j = 0;j < arr[i].length; j++) {
			document.getElementById(arr[0][0]).className = "btn-addwish-b2 dis-block pos-relative js-addwish-b2 js-addedwish-b2";
	}

	}
	document.getElementById("wishList").setAttribute('data-notify',arr.length);
